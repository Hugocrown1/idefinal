...
public class CalculadoraParser extends Parser {
	...
	public static final int
		T__0=1, T__1=2, IGUAL=3, MUL=4, DIV=5, SUM=6, RES=7, SALTO=8, INT=9, ID=10, 
		WSPACE=11;
	public static final int
		RULE_programa = 0, RULE_instrucciones = 1, RULE_expr = 2;
	private static String[] makeRuleNames() {
		return new String[] {
			"programa", "instrucciones", "expr"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, null, null, "IGUAL", "MUL", "DIV", "SUM", "RES", "SALTO", "INT", 
			"ID", "WSPACE"
		};
	}
	...
	public static class ProgramaContext extends ParserRuleContext {
		...
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculadoraVisitor ) return ((CalculadoraVisitor<? extends T>)visitor).visitPrograma(this);
	...
	public final ProgramaContext programa() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__0) | (1L << SALTO) | (1L << INT) | (1L << ID))) != 0) );
			}
		}
	...
	public static class AsignacionContext extends InstruccionesContext {
		...
		public TerminalNode SALTO() { return getToken(CalculadoraParser.SALTO, 0); }
		public AsignacionContext(InstruccionesContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculadoraVisitor ) return ((CalculadoraVisitor<? extends T>)visitor).visitAsignacion(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class VacioContext extends InstruccionesContext {
		public TerminalNode SALTO() { return getToken(CalculadoraParser.SALTO, 0); }
		public VacioContext(InstruccionesContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculadoraVisitor ) return ((CalculadoraVisitor<? extends T>)visitor).visitVacio(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class ImpresionContext extends InstruccionesContext {
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		public TerminalNode SALTO() { return getToken(CalculadoraParser.SALTO, 0); }
		public ImpresionContext(InstruccionesContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public static class ParentesisContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculadoraVisitor ) return ((CalculadoraVisitor<? extends T>)visitor).visitParentesis(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SumResContext extends ExprContext {
		...
		public TerminalNode RES() { return getToken(CalculadoraParser.RES, 0); }
		public SumResContext(ExprContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculadoraVisitor ) return ((CalculadoraVisitor<? extends T>)visitor).visitSumRes(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static final String _serializedATN =
		...
		"\2\17\27\3\2\2\2\20\21\7\f\2\2\21\22\7\5\2\2\22\23\5\6\4\2\23\24\7\n\2"+
		"\2\24\27\3\2\2\2\25\27\7\n\2\2\26\r\3\2\2\2\26\20\3\2\2\2\26\25\3\2\2"+
		"\2\27\5\3\2\2\2\30\31\b\4\1\2\31 \7\13\2\2\32 \7\f\2\2\33\34\7\3\2\2\34"+
