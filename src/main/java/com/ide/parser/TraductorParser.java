...
public class TraductorParser extends Parser {
	...
	public static class InicioContext extends EncabezadoContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitInicio(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeclaracionesContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitDeclaraciones(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IfGodContext extends If_stateContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitIfGod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ElseGodContext extends Else_stateContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitElseGod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ElseifgodContext extends ElseIf_stateContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitElseifgod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class WhileGodContext extends While_stateContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitWhileGod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeclarasigodContext extends DeclarasignarContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitDeclarasigod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeclaragodContext extends DeclaracionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitDeclaragod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ImpregodContext extends ImpresionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitImpregod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AsignagodContext extends AsignacionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitAsignagod(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class RelacionalContext extends CondicionContext {
		...
		public TerminalNode GT() { return getToken(TraductorParser.GT, 0); }
		public TerminalNode LT() { return getToken(TraductorParser.LT, 0); }
		public TerminalNode GTEQ() { return getToken(TraductorParser.GTEQ, 0); }
		public TerminalNode LTEQ() { return getToken(TraductorParser.LTEQ, 0); }
		public RelacionalContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitRelacional(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CondicionParentesisContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitCondicionParentesis(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class TrueGodContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitTrueGod(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class CondicionNContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitCondicionN(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class IgualdadContext extends CondicionContext {
		...
		public TerminalNode IG() { return getToken(TraductorParser.IG, 0); }
		public TerminalNode NIG() { return getToken(TraductorParser.NIG, 0); }
		public IgualdadContext(CondicionContext ctx) { copyFrom(ctx); }
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitIgualdad(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class OrExprContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitOrExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class FalseGodContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitFalseGod(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class AndExprContext extends CondicionContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitAndExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class IntnegContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitIntneg(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class DeclaracionesElseContext extends ParserRuleContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof TraductorVisitor ) return ((TraductorVisitor<? extends T>)visitor).visitDeclaracionesElse(this);
			else return visitor.visitChildren(this);
		}
	}
